            ...
            <FormProvider {...methods}>
                <form onSubmit={methods.handleSubmit((data) => next({ ...data, shippingCountry, shippingSubdivision, shippingOption }))}>
                    <Grid container spacing={3}>
                        ...
                        <input name="firstName" type="text" placeholder="Primer nombre" />
                        <input name="lastName" type="text" placeholder="Segundo nombre" />
                        <input name="address1" type="text" placeholder="Dirección" />
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                        <Button component={Link} to='/cart' variant="outlined">Regresar al carro</Button>
                        <Button type="submit" variant="outlined" color="primary">Siguiente</Button>
